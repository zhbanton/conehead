...
Sign in as <b>zack@zack.com (password: 'password')</b> to view data that is already populated or create your own account!
...
* View how much of each ingredient you will need in stock to fulfill your production cycle.
